<?php
// $Id: theme-settings.php,v 1.1 2009/07/19 18:14:52 garthee Exp $
...
function phptemplate_settings($saved_settings) {
  ...
  // iepngfix
  $form['tnt_container']['general_settings']['iepngfix'] = array(
    '#type' => 'fieldset',
    '#title' => t('IE PNG Fix'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['iepngfix']['iepngfix_display'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use IE PNG Fix'),
    '#default_value' => $settings['iepngfix_display'],
  );

  // colorswitch
  $form['tnt_container']['general_settings']['colorswitch'] = array(
    '#type' => 'fieldset',
    '#title' => t('Color Switcher'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['colorswitch']['colorswitch_display'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use Color Switch'),
    '#default_value' => $settings['colorswitch_display'],
  );
  // colorswitch foreground
  $form['tnt_container']['general_settings']['colorswitch']['foreground'] = array(
    '#type' => 'fieldset',
    '#title' => t('Foreground Settings'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['colorswitch']['foreground']['foreground_bg'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Background Color'),
    '#default_value' => $settings['foreground_bg'],
    '#description'   => t('Color to use as background. Use #FFF notation.'),
  );
  $form['tnt_container']['general_settings']['colorswitch']['foreground']['foreground_border'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Border Color'),
    '#default_value' => $settings['foreground_border'],
    '#description'   => t('Color to use for borders. Use #FFF notation.'),
  );
  $form['tnt_container']['general_settings']['colorswitch']['foreground']['foreground_font'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Font Color'),
    '#default_value' => $settings['foreground_font'],
    '#description'   => t('Color to use for font. Use #FFF notation.'),
  );

  // colorswitch background
  $form['tnt_container']['general_settings']['colorswitch']['background'] = array(
    '#type' => 'fieldset',
    '#title' => t('Background Settings'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['colorswitch']['background']['background_bg'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Background Color'),
    '#default_value' => $settings['background_bg'],
    '#description'   => t('Color to use as background. Use #FFF notation.'),
  );
  $form['tnt_container']['general_settings']['colorswitch']['background']['background_border'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Border Color'),
    '#default_value' => $settings['background_border'],
    '#description'   => t('Color to use for borders. Use #FFF notation.'),
  );
  $form['tnt_container']['general_settings']['colorswitch']['background']['background_font'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Font Color'),
    '#default_value' => $settings['background_font'],
    '#description'   => t('Color to use for font. Use #FFF notation.'),
  );

  // suckerfish
  $form['tnt_container']['general_settings']['suckerfish'] = array(
    '#type' => 'fieldset',
    '#title' => t('Suckerfish Menus'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['suckerfish']['suckerfish_display'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use Suckerfish Menus'),
    '#default_value' => $settings['suckerfish_display'],
  );
